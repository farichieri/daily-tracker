    ...
    <MainLayout>
      <div className="privacy">
        ...
        <p>
          ...
          information (&ldquo;Personal Information&ldquo;) that we gather when
          you are accessing or using our Services, but not to the practices of
          companies we don&apos;t own or control, or people that we don&apos;t
          manage. We gather various types of Personal Information from our
          users, as explained in more detail below, and we use this Personal
        ...
        <h2>Will this website ever change this Privacy Policy?</h2>
        <p>
          ...
          alert you to changes by updating the services on the website, placing
          a notice on the Services, by sending you an email, and/or by some
          other means. Please note that if you&apos;ve opted not to receive
          legal notice emails from us (or you haven&apos;t provided us with your
          email address), those legal notices will still govern your use of the
          ...
          information we collect now is subject to the Privacy Policy in effect
          at the time such information is used or collected.
        </p>
        ...
        <p>
          ...
          settings, we may collect Personal Information such as your name,
          title, email address, phone number, and third-party account
          credentials (for example, your log-in credentials for Twitter or other
          third party sites. If you provide your third-party account credentials
          to us or otherwise sign in to the Services through a third party site
          or service, you understand some content and/or information in those
          accounts (“Third Party Account Information”) may be transmitted into
          your account with us if you authorize such transmissions], and that
          Third Party Account Information transmitted to our Services is covered
          by this Privacy Policy. Certain information may be required to
        ...
        <p>
          ...
          device you&apos;re using to access our Services, and the page or
          ...
          party website or service, such third party may also transmit cookies
          to you. Again, this Privacy Policy does not cover the use of cookies
          by any third parties, and we aren&apos;t responsible for their privacy
        ...
        <p>
          ...
          you personally. For example, this aggregate data can tell us how often
        ...
        <h2>
          Will This website Share Any of the Personal Information it Receives?
        </h2>
        <p>
        ...
        <p>
          Information that&apos;s no longer personally identifiable. We may
          anonymize your Personal Information so that you are not individually
          identified, and provide that information to our partners. We may also
          provide aggregate usage information to our partners, who may use such
          ...
          experience. However, we never disclose aggregate information to a
        ...
        <p>
          ...
          will see their advertisements and/or promotional offers and you agree
          that we may provide any of the information we have collected from you
          in non-personally identifiable form to an Advertiser, in order for
          that Advertiser to select the appropriate audience for those
          ...
          are. Note that if an advertiser asks us to show an ad to a certain
        ...
        <p>
          ...
          network&apos;s servers, these companies can view, edit, or set their
          own cookies, just as if you had requested a web page from their site.
          You may be able to opt-out of web beacon tracking by adjusting the
        ...
        <p>
          ...
          or services to you through or in connection with the Services (either
          ...
          service may include the ability for you to automatically transmit
          Third Party Account Information to your Services profile or to
          automatically transmit information in your Services profile to your
          third party account; for example, you may sign into your This website
          account using your Twitter account. We have no control over the
        ...
        <p>
          ...
          agents do not have any right to use the Personal Information we share
        ...
        <p>
          ...
          your request for our services. Please remember that any content you
        ...
        <p>
          ...
          through some other change of control, Personal Information could be
          one of the assets transferred to or acquired by a third party.
        </p>
        <p>
          Protection of This website and Others: We reserve the right to access,
          ...
          apply ourTerms of Use and other agreements; or protect the rights,
          property, or safety of This website, our employees, our users, or
          others.
        </p>
        ...
        <p>
          ...
          finished accessing your account. We endeavor to protect the privacy of
          your account and other Personal Information we hold in our records,
